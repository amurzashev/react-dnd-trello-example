import { LANE_ADD_CARD, BOARD_ADD_LANE, BOARD_EDIT_LANE, LANE_REORDER_CARDS, LANE_REORDER_CARDS_BETWEEN_LANES } from '../actions/types';
...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case LANE_REORDER_CARDS_BETWEEN_LANES:
      return {
        ...state,
